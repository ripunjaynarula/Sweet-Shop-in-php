...
<main role="main">
  ...
  <section class="jumbotron text-center">
    <div class="container">
      ...
      <p>
        <a href="index.php" class="btn btn-primary my-2">View all sweets</a>
        <a href="#" class="btn btn-secondary my-2">Show new offers</a>
        <a href="index.php" class="btn btn-secondary my-2">Back to home</a>
